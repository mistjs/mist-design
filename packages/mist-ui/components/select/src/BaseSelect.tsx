...
import type { Key, VueNode } from '../../_utils/type';
import type {
  FocusEventHandler,
  KeyboardEventHandler,
  MouseEventHandler,
} from '../../_utils/tools/EventInterface';
import type { ScrollTo } from '../../_utils/vc-virtual-list/List';
import {
  computed,
  defineComponent,
  getCurrentInstance,
...
import { initDefaultProps, isValidElement } from '../../_utils/tools/props-util';
import isMobile from '../../_utils/vc-util/isMobile';
import KeyCode from '../../_utils/tools/KeyCode';
import { toReactive } from '@vueuse/core';
import classNames from '../../_utils/tools/classNames';
import createRef from '../../_utils/tools/createRef';
import type { BaseOptionType } from './Select';
import useInjectLegacySelectContext from '../../_utils/vc-tree-select/LegacyContext';
